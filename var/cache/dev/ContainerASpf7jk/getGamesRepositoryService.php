...
// Returns the private 'App\Repository\GamesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\GamesRepository.php';

return $this->privates['App\Repository\GamesRepository'] = new \App\Repository\GamesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
