...
// Returns the private 'App\Repository\TrophiesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TrophiesRepository.php';

return $this->privates['App\Repository\TrophiesRepository'] = new \App\Repository\TrophiesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
